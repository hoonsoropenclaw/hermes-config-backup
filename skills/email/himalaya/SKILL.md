...
# himalaya is NOT in apt repositories; do NOT use apt to install
curl -sSL https://raw.githubusercontent.com/pimalaya/himalaya/master/install.sh | PREFIX=~/.local sh

# Install to ~/bin specifically (used on this N100 system)
curl -sSL https://raw.githubusercontent.com/pimalaya/himalaya/master/install.sh | PREFIX=~ sh
# Result: ~/bin/himalaya v1.2.0 (28MB executable, all features built-in)
```
