...
#
# 安裝: ln -sf ~/.hermes/skills/agent-system-backup/scripts/hermes-backup-coverage-check.sh \
#           ~/.hermes/scripts/hermes-backup-coverage-check.sh
# (此腳本於 2026-07-11 curator pass 從 `devops/backup-coverage-check` 吸收合併入 agent-system-backup umbrella skill)
