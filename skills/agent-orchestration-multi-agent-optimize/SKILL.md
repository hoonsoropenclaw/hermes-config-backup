...
> **Hermes-specific summary** — For a condensed, Hermes-specific version with 5 actionable If→Then rules, see `references/delegation-patterns-foundations.md` → "Hermes-Specific Orchestration Patterns (2026-06-23 Synthesis)". The full 5-lesson Todo App experiment with raw wall-clock data is in `references/sub-agent-coding-integration-cost.md`.
