...
| 分類 | 檔案 | 條目數 | 觸發情境 |
|------|------|-------|----------|
| hermes-internal | `references/by-category/hermes-internal.md` | **23** | hermes CLI / cron / config 行為 / **驗證閉環失敗 (2026-06-09)** / **OpenClaw 反安裝 (2026-06-08)** / **bash_profile 互動式 return 阻擋 (2026-06-08)** / **SOP 寫設計變數不寫現況快照 (2026-06-09)** |
