...
## §2 給 engineering-lead 的「1 小時上手 checklist」

- [ ] 看完 ER Diagram 能在 draw.io / dbdiagram.io 畫出來(5 分鐘)
- [ ] 看完 8 張表規格能在 psql / pgAdmin 內建表(20 分鐘)
- [ ] 知道 1 年資料量級距(3K MAU 約 5-8 GB)
- [ ] 知道備份頻率跟還原 SLA
- [ ] 看完能在 1 小時內建立完整 dev DB

## §3 自我審查

- [x] ER Diagram 包含所有 Must-have User Story 對應實體
- [x] 8 張表都有主鍵、外鍵、約束、預設值
- [x] 索引對應高頻查詢(登入、列表、配對、訂單)
- [x] 5 個盲點都有對應 schema 設計
